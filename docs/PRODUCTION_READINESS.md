...
- [ ] `npm run compose:config` 通过，确认 dev、easy、HA-lite 和 image-based production Compose 文件均可解析，且第三方运行时镜像不使用字面量 `:latest`。
...
| --- | --- | --- | --- | --- | --- | --- |
| 2026-07-13 | `eb97174` | `20260713-034011` | 1 分钟 | 82 秒 | 受控 UAT 自动恢复演练通过 | 待人工签字 |
