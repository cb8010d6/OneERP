const fs = require('fs');
const content = `import { Injectable, OnModuleDestroy } from '@nestjs/common';
...
fs.writeFileSync('F:/enterprise-erp/apps/api/src/core/prisma/kysely.service.ts', content, 'utf8');
